 ...
 */
 ...
 static void interactive_powersave_bias_init(struct cpufreq_policy *policy)
 {
                     ...
                     const char *buf, size_t count)
 {
     ...
     list_for_each_entry(policy_dbs, &attr_set->policy_list, list)
         interactive_powersave_bias_init(policy_dbs->policy);
 ...
 static void od_start(struct cpufreq_policy *policy)
 {
     ...
     dbs_info->sample_type = OD_NORMAL_SAMPLE;
     interactive_powersave_bias_init(policy);
 }
 ...
 #define CPU_FREQ_GOV_INTERACTIVE	(od_dbs_gov.gov)
 ...
 static void od_set_powersave_bias(unsigned int powersave_bias)
 {
     ...
     for_each_online_cpu(cpu) {
         ...
         if (!policy || policy->governor != &CPU_FREQ_GOV_INTERACTIVE)
             continue;
